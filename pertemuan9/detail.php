...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="row mt-5">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="index.php"><i class="fas fa-user"></i> calon Mahasiswa</a><hr>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white" href="#"><i class="fas fa-user-edit"></i> Input camaba</a><hr>
      </li>
     <li class="nav-item">
        <a class="nav-link text-white" href="index.php"><i class="fas fa-chalkboard-teacher"></i> Daftar Dosen</a><hr>
      </li>
      <li class="nav-item">
      ...
      <div class="col-md-10 p-5 pt-5">
        <!-- konten -->
        <h3><i class="fas fa-user"></i>Detail data Calon Mahasiswa</h3>
        <hr>
    <ul class="list-group">
        ...
        <li><img src="image/foto1.jpg" width="500px"></li>
