    ...
    <div class="col-md-10 p-5 pt-5">
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item">
          <a href="edit.php?id<? $cmb['id']; ?>" class="btn btn-warning" role="button">Edit</a> I
          <a href="hapus.php?id<? $cmb['id']; ?>" class="btn btn-danger" role="button">Hapus</a> I
          <a href="index.php" class="btn btn-primary" role="button">Kembali</a> I
        </li>
      </ul>
    </div>
  </div>
