...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link href="tema/bootstrap/bootstrap/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    <!-- font -->
     ...
     <div class="col-md-2 mt-2 pr-3 pt-4 bg-secondary">
       <!-- menu -->
         <ul class="nav flex-column">
           <li class="nav-item">
            <a class="nav-link text-white" aria-current="page" href="#"> <i class="fas fa-tachometer-alt"></i> Dashboard</a><hr
            class= "bg-dark">
          </li>
          <li class="nav-item">
           ...
           <thead>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><img src="image/foto1.jpg" width="70px"></td>
                <td><i class="fas fa-edit"></i> I I <i class="fas fa-trash"></i></td>
              </tr>
              <?php $no++ ?>
              <?php }?>
            </tbody>
